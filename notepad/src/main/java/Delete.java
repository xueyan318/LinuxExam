...
public class Delete extends HttpServlet {
    ...
    static final String SQL_DELETE_NOTEPAD  = "delete from t_notepad where id = ?;";
    ...
    private Boolean delete(Notepad notepad) {
        Boolean flag = null;
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement(SQL_DELETE_NOTEPAD);
            // 填充占位符)
            ps.setString(1,notepad.getId());
